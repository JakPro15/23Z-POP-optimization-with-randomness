...
from helpers import Vector, get_initial_population
    ...
    for sigma1 in [1, 10]:
        for sigma2 in [1, 10]:
            for dimensions in dimensions_options:
                for population_size in [30, 50, 70]:
                    for differential_weight in [0.5, 0.8, 1.1]:
                        for crossover_threshold in [0.3, 0.5, 0.7]:
                            counter += 1
